...
var params = {
    ...
    status: ' This tweet was generated by https://github.com/axschech/check_qc'
};
            ...
            $('img').each(function (img, test) {
                if (img === 3) {
                    ...
                    if (parseInt(imgNum) === parseInt(curImg)) {
                        ...
                        message.html += "<p>This email was sent from <a href='http://github.com/axschech/check_qc'>check_qc</a></p>";
